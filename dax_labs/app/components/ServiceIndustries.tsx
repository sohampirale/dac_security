      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-[var(--color-text-secondary)] leading-relaxed">
            Our cybersecurity solutions are tailored to meet the unique challenges and compliance requirements of diverse industries.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {industries.map((industry, index) => (
            <div
              key={industry.name}
              className="group p-6 bg-[var(--color-bg-secondary)] rounded-lg border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-all duration-300 hover-lift text-center"
            ...
            >
              ...
              {/* Name */}
              <h3 className="mt-4 text-sm font-semibold text-[var(--color-text-primary)] leading-snug">
                {industry.name}
              </h3>
            </div>
          ))}
