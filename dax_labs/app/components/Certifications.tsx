        ...
        <div className="mx-auto mb-14 max-w-4xl text-center">
          ...
          <div className="grid max-w-5xl gap-8 mx-auto md:grid-cols-2 items-stretch">
            ...
            >
              ...
              <ul className="mt-4 grid gap-3 text-sm leading-6 text-[var(--color-text-secondary)] sm:text-base lg:grid-cols-2 opacity-80 transform translate-y-3 transition-all duration-600 group-hover:opacity-100 group-hover:translate-y-0" style={{transitionDelay:'700ms'}}>
