...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="bg-[var(--color-bg-secondary)] py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-10 sm:mb-14 max-w-4xl text-center">
          ...
          <p
            className={`text-sm sm:text-xl text-[var(--color-text-secondary)] leading-relaxed transition-all duration-700 sm:text-2xl ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          ...
          <div className="grid max-w-5xl gap-6 sm:gap-8 mx-auto md:grid-cols-2 items-stretch">
            ...
            >
              ...
              <div className="flex items-center mb-5 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[var(--color-accent)]/10 flex items-center justify-center mr-3 sm:mr-4">
                  <svg className="w-6 h-6 text-[var(--color-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4" />
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[var(--color-text-primary) transition-colors duration-150] group-hover:text-[var(--color-accent)]" style={{transitionDelay:'0ms'}}>
                  Certified Expertise
                </h3>
              </div>
              <ul className="mt-4 grid gap-3 text-xs sm:text-sm leading-6 text-[var(--color-text-secondary)] sm:text-base lg:grid-cols-2 opacity-80 transform translate-y-3 transition-all duration-600 group-hover:opacity-100 group-hover:translate-y-0" style={{transitionDelay:'700ms'}}>
